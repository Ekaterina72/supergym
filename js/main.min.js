...
require("./modules/sliders/swiper-sliders");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/sliders/swiper-sliders":11,"./modules/tabs/init-tabs":12,"./modules/video/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
var swiperCoaches = new _swiper.default('.coaches__slider', {
  loop: true,
  slidesPerView: 4,
  spaceBetween: 40,
  grabCursor: true,
...
var createSlidesTabs = function createSlidesTabs() {
...
exports.swiperReviews = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiperReviews = new _swiper.default('.reviews__slider', {
  slidesPerView: 1,
  spaceBetween: 100,
  centeredSlides: true,
  navigation: {
...
exports.swiperReviews = swiperReviews;
...
Object.defineProperty(exports, "swiperCoaches", {
  enumerable: true,
  get: function get() {
    return _swiperCoaches.swiperCoaches;
  }
});
Object.defineProperty(exports, "swiperReviews", {
  enumerable: true,
  get: function get() {
    return _swiperReviews.swiperReviews;
  }
});
var _swiperCoaches = require("./swiper-coaches");
var _swiperReviews = require("./swiper-reviews");

},{"./swiper-coaches":9,"./swiper-reviews":10}],12:[function(require,module,exports){
"use strict";
...
var createVideoIframe = function createVideoIframe(container, replacingElement) {
  var videoLink = 'https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1';
...
var initVideo = function initVideo() {
  ...
  var videoLinkElement = document.querySelector('[data-video-link]');
  var videoButtonElement = document.querySelector('[data-video-button]');
